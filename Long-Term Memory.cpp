...
void _LongTermMemory::LongTermMemoryRawSearchTermDateLeft(string search, int year, int month, int day, int hour, int minutes, int seconds)
{
...
void _LongTermMemory::LongTermMemoryRawSearchTermDateRight(string search, int year, int month, int day, int hour, int minutes, int seconds)
{
    MYSQL* conn = mysql_init(NULL);
}
