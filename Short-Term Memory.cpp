...
void _ShortTermMemory::AddShortTermMemory(string _vision_path_camera1, string _vision_path_camera2, string _sound_path, string _speech_dialogue, string _reading_text, string _action1_text, string _action2_text, string _action3_text, string _vision_objects_image_path, string _vision_actions_image_path, string _vision_object_text, string _vision_analysis_text, string _typing_text, string __Reference_pos_gps_north, string __Reference_pos_gps_west, string __Reference_pos_gps_elevation, string __Reference_pos_gps_image, string _pos_gps_north, string _pos_gps_west, string _pos_gps_elevation, string _pos_x, string _pos_y, string _pos_z)
{
    ...
    if (_vision_path_camera1 != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_vision_path_camera1[1000][0] = _vision_path_camera1;
            stm_vision_path_camera1[1000][1] = current_time.years + "-";
            stm_vision_path_camera1[1000][1] += current_time.months + "-";
            stm_vision_path_camera1[1000][1] += current_time.days + ":";
            stm_vision_path_camera1[1000][1] += current_time.hours + "-";
            stm_vision_path_camera1[1000][1] += current_time.minutes + "-";
            stm_vision_path_camera1[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_vision_path_camera2 != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_vision_path_camera2[1000][0] = _vision_path_camera1;
            stm_vision_path_camera2[1000][1] = current_time.years + "-";
            stm_vision_path_camera2[1000][1] += current_time.months + "-";
            stm_vision_path_camera2[1000][1] += current_time.days + ":";
            stm_vision_path_camera2[1000][1] += current_time.hours + "-";
            stm_vision_path_camera2[1000][1] += current_time.minutes + "-";
            stm_vision_path_camera2[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_sound_path != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_sound_path[1000][0] = _sound_path;
            stm_sound_path[1000][1] = current_time.years + "-";
            stm_sound_path[1000][1] += current_time.months + "-";
            stm_sound_path[1000][1] += current_time.days + ":";
            stm_sound_path[1000][1] += current_time.hours + "-";
            stm_sound_path[1000][1] += current_time.minutes + "-";
            stm_sound_path[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_speech_dialogue != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_speech_dialogue[1000][0] = _speech_dialogue;
            stm_speech_dialogue[1000][1] = current_time.years + "-";
            stm_speech_dialogue[1000][1] += current_time.months + "-";
            stm_speech_dialogue[1000][1] += current_time.days + ":";
            stm_speech_dialogue[1000][1] += current_time.hours + "-";
            stm_speech_dialogue[1000][1] += current_time.minutes + "-";
            stm_speech_dialogue[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_reading_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_reading_text[1000][0] = _reading_text;
            stm_reading_text[1000][1] = current_time.years + "-";
            stm_reading_text[1000][1] += current_time.months + "-";
            stm_reading_text[1000][1] += current_time.days + ":";
            stm_reading_text[1000][1] += current_time.hours + "-";
            stm_reading_text[1000][1] += current_time.minutes + "-";
            stm_reading_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_action1_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_action1_text[1000][0] = _action1_text;
            stm_action1_text[1000][1] = current_time.years + "-";
            stm_action1_text[1000][1] += current_time.months + "-";
            stm_action1_text[1000][1] += current_time.days + ":";
            stm_action1_text[1000][1] += current_time.hours + "-";
            stm_action1_text[1000][1] += current_time.minutes + "-";
            stm_action1_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_action2_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_action2_text[1000][0] = _action2_text;
            stm_action2_text[1000][1] = current_time.years + "-";
            stm_action2_text[1000][1] += current_time.months + "-";
            stm_action2_text[1000][1] += current_time.days + ":";
            stm_action2_text[1000][1] += current_time.hours + "-";
            stm_action2_text[1000][1] += current_time.minutes + "-";
            stm_action2_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_action3_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_action3_text[1000][0] = _action3_text;
            stm_action3_text[1000][1] = current_time.years + "-";
            stm_action3_text[1000][1] += current_time.months + "-";
            stm_action3_text[1000][1] += current_time.days + ":";
            stm_action3_text[1000][1] += current_time.hours + "-";
            stm_action3_text[1000][1] += current_time.minutes + "-";
            stm_action3_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_vision_objects_image_path != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_vision_objects_image_path[1000][0] = _vision_objects_image_path;
            stm_vision_objects_image_path[1000][1] = current_time.years + "-";
            stm_vision_objects_image_path[1000][1] += current_time.months + "-";
            stm_vision_objects_image_path[1000][1] += current_time.days + ":";
            stm_vision_objects_image_path[1000][1] += current_time.hours + "-";
            stm_vision_objects_image_path[1000][1] += current_time.minutes + "-";
            stm_vision_objects_image_path[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_vision_actions_image_path != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_vision_actions_image_path[1000][0] = _vision_actions_image_path;
            stm_vision_actions_image_path[1000][1] = current_time.years + "-";
            stm_vision_actions_image_path[1000][1] += current_time.months + "-";
            stm_vision_actions_image_path[1000][1] += current_time.days + ":";
            stm_vision_actions_image_path[1000][1] += current_time.hours + "-";
            stm_vision_actions_image_path[1000][1] += current_time.minutes + "-";
            stm_vision_actions_image_path[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_vision_object_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_vision_objects_text[1000][0] = _vision_object_text;
            stm_vision_objects_text[1000][1] = current_time.years + "-";
            stm_vision_objects_text[1000][1] += current_time.months + "-";
            stm_vision_objects_text[1000][1] += current_time.days + ":";
            stm_vision_objects_text[1000][1] += current_time.hours + "-";
            stm_vision_objects_text[1000][1] += current_time.minutes + "-";
            stm_vision_objects_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_vision_analysis_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_vision_analysis_text[1000][0] = _vision_analysis_text;
            stm_vision_analysis_text[1000][1] = current_time.years + "-";
            stm_vision_analysis_text[1000][1] += current_time.months + "-";
            stm_vision_analysis_text[1000][1] += current_time.days + ":";
            stm_vision_analysis_text[1000][1] += current_time.hours + "-";
            stm_vision_analysis_text[1000][1] += current_time.minutes + "-";
            stm_vision_analysis_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_typing_text != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_typing_text[1000][0] = _typing_text;
            stm_typing_text[1000][1] = current_time.years + "-";
            stm_typing_text[1000][1] += current_time.months + "-";
            stm_typing_text[1000][1] += current_time.days + ":";
            stm_typing_text[1000][1] += current_time.hours + "-";
            stm_typing_text[1000][1] += current_time.minutes + "-";
            stm_typing_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    ...
    if (_pos_gps_north != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_pos_gps_north_text[1000][0] = _pos_gps_north;
            stm_pos_gps_north_text[1000][1] = current_time.years + "-";
            stm_pos_gps_north_text[1000][1] += current_time.months + "-";
            stm_pos_gps_north_text[1000][1] += current_time.days + ":";
            stm_pos_gps_north_text[1000][1] += current_time.hours + "-";
            stm_pos_gps_north_text[1000][1] += current_time.minutes + "-";
            stm_pos_gps_north_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_pos_gps_west != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_pos_gps_west_text[1000][0] = _pos_gps_west;
            stm_pos_gps_west_text[1000][1] = current_time.years + "-";
            stm_pos_gps_west_text[1000][1] += current_time.months + "-";
            stm_pos_gps_west_text[1000][1] += current_time.days + ":";
            stm_pos_gps_west_text[1000][1] += current_time.hours + "-";
            stm_pos_gps_west_text[1000][1] += current_time.minutes + "-";
            stm_pos_gps_west_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_pos_gps_elevation != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_pos_gps_elevation_text[1000][0] = _pos_gps_elevation;
            stm_pos_gps_elevation_text[1000][1] = current_time.years + "-";
            stm_pos_gps_elevation_text[1000][1] += current_time.months + "-";
            stm_pos_gps_elevation_text[1000][1] += current_time.days + ":";
            stm_pos_gps_elevation_text[1000][1] += current_time.hours + "-";
            stm_pos_gps_elevation_text[1000][1] += current_time.minutes + "-";
            stm_pos_gps_elevation_text[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_pos_x != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_pos_x[1000][0] = _pos_x;
            stm_pos_x[1000][1] = current_time.years + "-";
            stm_pos_x[1000][1] += current_time.months + "-";
            stm_pos_x[1000][1] += current_time.days + ":";
            stm_pos_x[1000][1] += current_time.hours + "-";
            stm_pos_x[1000][1] += current_time.minutes + "-";
            stm_pos_x[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_pos_y != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_pos_y[1000][0] = _pos_y;
            stm_pos_y[1000][1] = current_time.years + "-";
            stm_pos_y[1000][1] += current_time.months + "-";
            stm_pos_y[1000][1] += current_time.days + ":";
            stm_pos_y[1000][1] += current_time.hours + "-";
            stm_pos_y[1000][1] += current_time.minutes + "-";
            stm_pos_y[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
    if (_pos_z != "")
    {
        ...
        if (boolean)
        {
            ...
            stm_pos_z[1000][0] = _pos_z;
            stm_pos_z[1000][1] = current_time.years + "-";
            stm_pos_z[1000][1] += current_time.months + "-";
            stm_pos_z[1000][1] += current_time.days + ":";
            stm_pos_z[1000][1] += current_time.hours + "-";
            stm_pos_z[1000][1] += current_time.minutes + "-";
            stm_pos_z[1000][1] += current_time.seconds;
            boolean = false;
        }
    }
}
