...
/*
    ...
    Planning
    A child’s ability to think about the future, create a plan of action, and prioritize the different working parts is a strong sign of cognitive development.Planning skills allow a child to make a list of operations designed to effectively accomplish a taskand to adequately determine which aspects are the most important.Some examples of planning are making a packing list, giving directions, or writing a recipe.
