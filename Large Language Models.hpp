...
public:
    ...
    //static void Thought2MySQL(string prompt, string response, string thought_analysis, string keywords, string duration);
...
public:
    ...
    static void llm_api_thread();
    static void llm_api_threadv2();
    static uint32_t request_hash(const std::string& str);
    static bool has_response();
};
