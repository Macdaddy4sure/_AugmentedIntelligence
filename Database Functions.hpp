...
{
public:
    static string FindObject(string object);
    static void StoreObject(string object, string image_location);
    ...
    static void savePassword(string hostname, string password, string image_location);
