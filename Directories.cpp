...
string* _Directories::init_earth_c_directory()
{
    ...
    erase_table = mysql_real_connect(erase_table, "127.0.0.1", mysql_username.c_str(), mysql_password.c_str(), mysql_database.c_str(), 3306, NULL, 0);
    ...
    create_table = mysql_real_connect(create_table, "127.0.0.1", mysql_username.c_str(), mysql_password.c_str(), mysql_database.c_str(), 3306, NULL, 0);
    ...
    for (auto& p : recursive_directory_iterator(earth_c.c_str()))
    {
        ...
        insert_data = mysql_real_connect(insert_data, "127.0.0.1", mysql_username.c_str(), mysql_password.c_str(), mysql_database.c_str(), 3306, NULL, 0);
