...
vector<string> _Economics::EconomicsClassification(string text)
{
    vector<string> economics_terms(100);
    string temp;

    //if (_Economics::Terms::AbsoluteAdvantage(text) != "NULL")
    //if (_Economics::Terms::Absorption(text) != "NULL")
    //if (_Economics::Terms::AbandonmentOfTheGoldStandard(text) != "NULL")
    //if (_Economics::Terms::AcceleratorEffect(string text))

    return economics_terms;
}
