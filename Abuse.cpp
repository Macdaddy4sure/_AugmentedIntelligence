...
vector<string> _Abuse::CheckAbuse(string text)
{
    string temp;
    vector<string> abuses(100);
...
bool _Abuse::Terms::GaslightingVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::TriangulationVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::ProjectionVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::NameCallingVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::GeneralizationsVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::MovingGoalpostsVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::LoveBombVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::ChangingSubjectVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::PlayingInsecuritiesVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::SilentTreatmentVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::PassiveAggressiveVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::DismissiveDiminishingVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::ChildLabellingVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::VictimBlamingVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::GuiltTripVision(string image_location)
{
    return false;
}

bool _Abuse::Terms::ThreatsCoersionVision(string image_location)
{
    return false;
}