...
/*
    ...
    8. Love Bombing
    Love bombing is when someone bombards a person with affection, intense emotions, and an excess of their timeand energy.5 This can include gift giving, making elaborate declarations of admiration, and spending all of one’s timeand energy on pleasing the victim.A manipulator uses love bombing to quickly build intimacyand trust.
    This also gives the victim an ideal interaction to pursue.In this way, a manipulator preys on a person’s natural desire to feel wantedand appreciatedand turns it into a tool to increase the victim’s devotion to them.
    ...
    An emotional manipulator does this to make sure the victim feels like they cannot get praise from any source other than the manipulator, and to have the victim question their own abilitiesand intelligence.
    ...
    Ultimately, this keeps the focus –and the power – on the manipulator, so that the victim doesn’t have timeand attention to evaluate their own feelings in the relationship.
    ...
    This can come in the form of talking down to a person like they’re less intelligent, stepping inand taking over in the middle of a task the person is capable of doing on their own, or physically treating them like they’re incapable of certain tasks.
    ...
    While they may not actually hurt themselves, it’s important to always take threats of self - harm seriously.Holding your boundaries for physicaland emotional safety is critically important, and so is encouraging the other person to seek professional help if they threaten self - harm.
*/