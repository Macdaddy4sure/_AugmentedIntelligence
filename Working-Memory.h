...
static string wm_vision_camera1[1000][4];
static mutex mtx_wm_vision_camera1[1000][4];
static string wm_vision_camera2[1000][4];
static mutex mtx_wm_vision_camera2[1000][4];
static string wm_sound[1000][3];
static mutex mtx_wm_sound[1000][3];
...
static string wm_reading[1000][2];
static mutex mtx_wm_reading_text[1000][2];
//static string wm_reading_image[1000][2];
//static mutex mtx_wm_reading_image[1000][2];
...
static string wm_vision_objects_image_camera1[1000][2];
static mutex mtx_wm_vision_objects_image_camera1[1000][2];
static string wm_vision_objects_image_camera2[1000][2];
static mutex mtx_wm_vision_objects_image_camera2[1000][2];
static string wm_vision_actions_image_camera1[1000][2];
static mutex mtx_wm_vision_actions_image_camera1[1000][2];
static string wm_vision_actions_image_camera2[1000][2];
static mutex mtx_wm_vision_actions_image_camera2[1000][2];
...
static string wm_vision_analysis_camera1[1000][2];
static mutex mtx_wm_vision_analysis_camera1[1000][2];
static string wm_vision_analysis_camera2[1000][2];
static mutex mtx_wm_vision_analysis_camera2[1000][2];
