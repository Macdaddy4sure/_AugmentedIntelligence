...
static string stm_vision_camera1[1000][4];                             // 60 frames per second = 5184000 frames per 24 hours
static mutex mtx_stm_vision_camera1[1000][4];
static string stm_vision_camera2[1000][4];
static mutex mtx_stm_vision_camera2[1000][4];
static string stm_sound[1000][3];                                    // 86400 seconds = 24 hours of recording for stm
static mutex mtx_stm_sound[1000][3];
//static string stm_speech_dialogue[1000][2];                  // 11404800 lines of dialogue per 24 hours
//static mutex mtx_stm_speech_dialogue[1000][2];
static string stm_vision_objects_image_camera1[1000][65];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_objects_image_camera1[1000][65];
static string stm_vision_objects_image_camera2[1000][65];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_objects_image_camera2[1000][65];
static string stm_vision_actions_image_camera1[1000][2];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_actions_image_camera1[1000][2];
static string stm_vision_actions_image_path_camera2[1000][2];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_actions_image_path_camera2[1000][2];
//static string stm_vision_objects_text_camera1[1000][2];                // 5184000 lines for 24 hours
//static mutex mtx_stm_vision_objects_text_camera1[1000][2];
//static string stm_vision_objects_text_camera2[1000][2];                // 5184000 lines for 24 hours
//static mutex mtx_stm_vision_objects_text_camera2[1000][2];
static string stm_vision_analysis_camera1[1000][4];               // 5184000 lines for 24 hours
static mutex mtx_stm_vision_analysis_camera1[1000][4];
static string stm_vision_analysis_camera2[1000][4];
static mutex mtx_stm_vision_analysis_camera2[1000][4];
//static string stm_action1_text[1000][2];                       // 5184000 lines for 24 hours
//static mutex mtx_stm_action1_text[1000][2];
//static string stm_action2_text[1000][2];                       // 5184000 lines for 24 hours
//static mutex mtx_stm_action2_text[1000][2];
//static string stm_action3_text[1000][2];                       // 5184000 lines for 24 hours
//static mutex mtx_stm_action3_text[1000][2];
static string stm_reading_text[1000][2];                    // 11404800 lines of dialogue per 24 hours
static mutex mtx_stm_reading_text[1000][2];
static string stm_algebra_text[1000][2];
static mutex mtx_stm_algebra_text[1000][2];
static string stm_reading[1000][3];
static mutex mtx_stm_reading[1000][3];
static string stm_typing_text[1000][2];                      // 11404800 lines of dialogue per 24 hours
static mutex mtx_stm_typing_text[1000][2];
static string stm_Reference_pos_gps_north[1000][2];
static mutex mtx_stm_Reference_pos_gps_north[1000][2];
static string stm_Reference_pos_gps_west[1000][2];
static mutex mtx_stm_Reference_pos_gps_west[1000][2];
static string stm_Reference_pos_gps_elevation[1000][2];
static mutex mtx_stm_Reference_pos_gps_elevation[1000][2];
static string stm_Reference_pos_gps_image[1000][2];
static mutex mtx_stm_Reference_pos_gps_image[1000][2];
static string stm_pos_gps_north_text[1000][2];
static mutex mtx_stm_pos_gps_north_text[1000][2];
static string stm_pos_gps_west_text[1000][2];
static mutex mtx_stm_pos_gps_west_text[1000][2];
static string stm_pos_gps_elevation_text[1000][2];
static mutex mtx_stm_pos_gps_elevation_text[1000][2];
static string stm_pos_x[1000][2];
static mutex mtx_stm_pos_x[1000][2];
static string stm_pos_y[1000][2];
static mutex mtx_stm_pos_y[1000][2];
static string stm_pos_z[1000][2];
static mutex mtx_stm_pos_z[1000][2];
static string stm_simple_text[1000][2];
static mutex mtx_stm_simple_text[1000][2];
static string stm_simple_image[1000][2];
static mutex mtx_stm_simple_image[1000][2];