...
static mutex mtx_stm_vision_path_camera1[1000][2];
static string stm_vision_path_camera2[1000][2];
static mutex mtx_stm_vision_path_camera2[1000][2];
static string stm_sound_path[1000][4];                                    // 86400 seconds = 24 hours of recording for stm
static mutex mtx_stm_sound_path[1000][4];
...
static string stm_vision_objects_image_path_camera1[1000][2];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_objects_image_path_camera1[1000][2];
static string stm_vision_objects_image_path_camera2[1000][2];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_objects_image_path_camera2[1000][2];
static string stm_vision_actions_image_path_camera1[1000][2];                   // 5184000 lines for 24 hours
static mutex mtx_stm_vision_actions_image_path_camera1[1000][2];
...
static string stm_vision_analysis_text_camera1[1000][2];               // 5184000 lines for 24 hours
static mutex mtx_stm_vision_analysis_text_camera1[1000][2];
static string stm_vision_analysis_text_camera2[1000][2];
static mutex mtx_stm_vision_analysis_text_camera2[1000][2];
...
static mutex mtx_stm_reading_image[1000][2];
