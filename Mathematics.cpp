...
// Fix this
// This function checks if there a match for a number
int _Math::NumberName(string text)
{
    MYSQL* conn;
    MYSQL_ROW row;
    MYSQL_RES* result;
    ...
    ostringstream query1;
    string sql1;
    string database1 = "NumberNames";
    string table_name = "NumberNames";
    int number;
